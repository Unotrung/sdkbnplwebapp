lang = {
    showAllProvider: {
        choose_provider: "Chọn nhà cung cấp BNPL",
    },

    listProductions: {
        order_info: "Thông tin đơn hàng",
        add_promotion: "Thêm mã giảm giá hoặc thẻ quà tặng",
        amount: "Thành tiền",
    ...
    configUi: {
        slogan1: "Mua trước Trả sau Không khoản trả trước",
        slogan2: "Nhẹ nhàng với 0% lãi suất",
        voolo_intro: "VOOLO giúp bạn:",
        feature_voolo_intro_1: "Mua sắm không giới hạn",
        feature_voolo_intro_2: "Thanh toán linh hoạt",
        feature_voolo_intro_3: "Hoàn tiền ngay chỉ trong 1 ngày",
    },
    ...
    showUICheckNid: {
        type_nid: "Vui lòng nhập số CMND/CCCD",
        capture_selfie: "Chụp ảnh chân dung",
        invalid_nid: "Số CMND/CCCD không hợp lệ",
        empty_nid: "Vui lòng nhập CMND/CCCD",
        registered_nid: "Số CMND/CCCD đã được đăng ký.",
    },
    ...
    cutStringData: {
        ...
        not_match_nid_front: "Số CMND/CCCD trước không trùng khớp,<br/> đề nghị chụp lại",
        error_capture_front_nid: "Lỗi chụp CMND/CCCD<br/>Mặt trước, đề nghị chụp lại",
    },

    makeFaceMatchCall: {
        not_match_selfie: "Ảnh chân dung và ảnh trên CMND/CCCD không khớp, đề nghị chụp lại ảnh.",
    },

    LaunchFaceCaptureScreen: {
        capture_selfie: "Chụp ảnh chân dung",
        use_phone_and_device: "Bạn đang chụp ảnh chân dung để đăng ký tài khoản (KYC). Vui lòng sử dụng số điện thoại và thiết bị của bạn.",
        capture_rules: "Vui lòng KHÔNG đội nón, đeo kính, khẩu trang, chọn nơi có đủ ánh sáng để chụp ảnh",
        away_camera: "Cách xa camera",
        capture_now: "Chụp ảnh ngay",
    ...
    LaunchDocumentCaptureScreen: {
        ...
        capture_front: "Chụp ảnh mặt trước",
        capture_back: "Chụp ảnh mặt sau",
    ...
    onHandleChangeDataCity: {
        type_district: "Vui lòng nhập quận, huyện",
        type_city: "Vui lòng nhập thành phố, tỉnh",
    },

    showDataInform: {
        type_info: "Nhập thông tin cá nhân",
        enter_all_field: "Vui lòng điền các trường thông tin bên dưới",
        info: "Thông tin cá nhân",
        info_name: "Họ và tên",
        type_name: "Vui lòng nhập họ và tên",
        info_phone: "Số điện thoại",
        type_phone: "Vui lòng nhập số điện thoại",
        info_birth: "Ngày sinh",
        info_gender: "Giới tính",
        choose_gender: "Chọn giới tính",
        gender_man: "Nam",
        gender_woman: "Nữ",
        info_nid: "Số CMND/CCCD",
        type_nid: "Vui lòng nhập CMND/CCCD",
        info_doi: "Ngày cấp",
        info_doe: "Ngày hết hạn",
        current_address: "Địa chỉ hiện tại",
        info_city: "Thành phố/Tỉnh",
        choose_city: "Chọn thành phố/tỉnh",
        info_district: "Quận/Huyện",
        choose_district: "Chọn quận/huyện",
        info_ward: "Phường/Xã",
        choose_ward: "Chọn phường/xã",
        type_ward: "Vui lòng nhập phường, xã",
        info_street: "Đường",
        type_street: "Vui lòng nhập đường",
        res_address: "Địa chỉ tạm trú",
        reference_info: "Thông tin tham chiếu",
        relationship: "Mối quan hệ",
        type_relation: "Vui lòng nhập mối quan hệ",
        info_name_ref: "Họ và tên",
        type_name_ref: "Vui lòng nhập họ và tên",
        info_phone_ref: "Số điện thoại",
        type_phone_ref: "Vui lòng nhập Số điện thoại",
        capture_selfie: "Chụp ảnh chân dung",
        invalid_phone: "Số điện thoại không hợp lệ",
        invalid_nid: "CMND/CCCD không hợp lệ",
        same_phone: "Số điện thoại tham chiếu trùng số điện thoại đăng ký",
    },
    ...
    forgotPinPhone: {
        ...
        empty_phone: "Vui lòng nhập số điện thoại để tiếp tục",
        invalid_phone: "Số điện thoại không hợp lệ",
        type_phone: "Vui lòng nhập số điện thoại",
    },

    forgotPinNid: {
        empty_nid: "Vui lòng nhập số CMND/CCCD",
        invalid_nid: "Số CMND/CCCD không hợp lệ",
        type_nid: "Vui lòng nhập CMND/CCCD",
        error_OTP: "Mã OTP không chính xác",
        error_acc: "Tài khoản chưa tồn tại. Vui lòng đăng ký",
        error_nid_retype: "Số CMND/CCCD không đúng. Vui lòng nhập số khác.",
    },

    showFormPincode: {
        type_pin: "Nhập mã PIN",
        type_payment: "Vui lòng nhập mã PIN để thanh toán",
        info_pin: "Mã PIN",
        info_pin_verify: "Vui lòng nhập mã PIN để xác thực thông tin",
        pin_verify_payment: "Vui lòng nhập mã PIN để xác thực thanh toán",
        forgot_pin: "Quên mã PIN?",
        click: "Nhấn vào đây",
        error_type_pin: "Vui lòng nhập mã PIN",
        invalid_phone: "Số điện thoại không hợp lệ",
        error_incorrect_pin: "Mã PIN không chính xác",
        error_incorrect_pin_5: "Mã PIN không chính xác (5/5).</br>Tài khoản của bạn đã bị khóa, thử lại sau 60 phút.",
    },
    ...
    showFormSetupPin: {
        ...
        send_info: "Đã gửi thông tin thành công",
        notification_unsuccess: "Không thành công",
        error_send_info: "Lỗi gửi thông tin, vui lòng thử lại!",
        not_match_pin: "Mã PIN không trùng khớp",
    },
    ...
    showFormVerifyOTP: {
        ...
        not_receive_OTP: "Không nhận được OTP?",
        resend_OTP: "Gửi lại OTP ",
        error_incorrect_OTP: "Mã OTP không chính xác",
        error_incorrect_OTP_5: "Mã OTP không chính xác (5/5). Vui lòng thử lại sau 60 phút",
    ...
    customerInfo: {
        congratulation: "Chúc mừng bạn, với hạn mức tín dụng này bạn đủ điều kiện để hoàn tất đơn hàng.",
    ...
    showProcessPipeline: {
        buy_now_pay_later: "Chào mừng bạn đến với quy trình đăng ký Mua trước Trả sau",
        cus_info: "Thông tin khách hàng",
        setup_pin: "Cài đặt PIN",
        sign_onl: "Ký điện tử",
        verify_info: "Xác minh thông tin",
        complete: "Hoàn thành",
    },
    ...
    messageScreen: {
        ...
        update_fail_pin: "Cập nhật mã PIN không thành công",
        update_success_pin: "Cập nhật mã PIN thành công",
    ...
    showUICheckNid : {
        ...
        error_nid_null : "Vui lòng nhập CMND/CCCD",
        error_nid_registered : "CMND/CCCD đã được đăng ký.",
    ...
    showDataInform : {
        ...
        gender_woman : "Nữ",
        nid : "Số CMND/CCCD",
        input_nid : "Vui lòng nhập CMND/CCCD",
        doi : "Ngày cấp",
        doe : "Ngày hết hạn",
        cur_address : "Địa chỉ hiện tại",
        city : "Thành phố/Tỉnh",
        choose_city : "Chọn thành phố/tỉnh",
        district : "Quận/Huyện",
        choose_district : "Chọn quận/huyện",
        wards : "Phường/Xã",
        choose_wards : "Chọn phường/xã",
        input_wards : "Vui lòng nhập phường, xã",
        street : "Đường",
        input_street : "Vui lòng nhập đường",
        res_address : "Địa chỉ tạm trú",
        reference_info : "Thông tin tham chiếu",
        relationship : "Mối quan hệ",
        input_relation : "Vui lòng nhập mối quan hệ",
        info_name_ref : "Họ và tên",
        input_name_ref : "Vui lòng nhập họ và tên",
        info_phone_ref : "Số điện thoại",
    ...
    showFormPincode : {
        ...
        pin : "Mã PIN",
        pin_verify_info : "Vui lòng nhập mã PIN để xác thực thông tin",
        pin_verify_payment : "Vui lòng nhập mã PIN để xác thực thanh toán",
        forgot_pin : "Quên mã PIN? ",
        click : "Nhấn vào đây",
        error_input_pin : "Vui lòng nhập mã PIN",
        error_phone : "Số điện thoại không hợp lệ",
        error_incorrect_pin : "Mã PIN không chính xác",
        error_incorrect_pin_5 : "Mã PIN không chính xác (5/5).</br>Tài khoản của bạn đã bị khóa, thử lại sau 60 phút.",
    },
    ...
    showFormVerifyOTP : {
        input_OTP : "Nhập OTP",
        sent_OTP : "Mã OTP đã được gửi đến số điện thoại ",
        OTP_not_receive : "Không nhận được OTP?",
        resend_OTP : "Gửi lại OTP ",
        error_incorrect_OTP : "Mã OTP không chính xác",
        error_incorrect_OTP_5 : "Mã OTP không chính xác (5/5). Vui lòng thử lại sau 60 phút",
        error_expired_OTP : "Mã OTP hết hiệu lực",  
