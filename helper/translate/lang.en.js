lang = {
    ...
    configUi: {
        slogan: "WORRY-FREE shopping with VOOLO",
        voolo_intro: "Pay later. Choose VOOLO.",
        sub_voolo_intro: "<ul><li>Buy everything you need </li><li>Flexible payment plans </li><li>Get cashback after just 1 day </li></ul>",
    },
    ...
    showUICheckNid: {
        input_nid: "Please enter your National ID number",
    ...
    forgotPinNid: {
        input_nid_null: "Please enter your National ID number",
        error_nid: "Invalid national ID",
        input_nid: "Please enter national ID number",
