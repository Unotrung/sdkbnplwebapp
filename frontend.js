    ...
    $('#btnSubmitPin').click(function () {
        ...
        if (pin === pincf) {
            if (screen === 'SHOW_LOGIN') {
                ...
                localStorage.removeItem('personal_all_info');
                localStorage.removeItem('front-image');
                localStorage.removeItem('back-image');
                localStorage.removeItem('selfie-image');

                localStorage.removeItem('back_nid_customer');
                localStorage.removeItem('front_nid_customer');
                localStorage.removeItem('checkCustomer');
                localStorage.removeItem('allDataNid');
            }
            ...
            addBorderGray('setuppin');
            addBorderGray('setupcfpin');
            btnSubmitPin.disabled = true;
        }
    })
}
