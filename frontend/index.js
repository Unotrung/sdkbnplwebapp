                ...
                makeFaceMatchCall(sessionStorage.getItem('selfie-image'), sessionStorage.getItem('front-image')).then((data) => {
                    if (data) {
                        if (nid !== idNumber) {
                            ...
                            close_popup();
                            if (showPopupMessage(lang.cutStringData.notification, lang.cutStringData.not_match_nid_front)) {
    ...
    $('.input-global').on('input', function () {
        ...
        if ($(this).attr("id") === 'phone_ref') {
            ...
            if (!isPhoneRefError) {
                ...
                isActivePhone = false;
                showMessageStatus(phone_refEle, lang.showDataInform.invalid_nid, 'ERROR');
            }
        }
